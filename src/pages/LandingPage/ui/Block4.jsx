import styles from '../../../shared/style/landing/block4/block4Style.module.css';
import { Link } from 'react-router-dom';
import Img3 from '../../../shared/assets/landing/images/3.png';
export const Block4 =() => {
  return(

    <div className={styles.block4}>
      <span>как попасть на сервер?</span>
      <div className={styles.block4middle}>
