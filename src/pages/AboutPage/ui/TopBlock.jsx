import styles from '../../../shared/style/about/topBlock/topBlock.module.css';

export const TopBlock = () => {
  return(
    <div className={styles.topBlockContainer}>
      <span className={styles.topBlockTitle}>S10YM - survival 10 year minecraft (выживание 10 лет в майнкрафтe)</span>
      ...
      <span className={styles.topBlockSubtitle}>При этом каждый желающий имеет возможность принять участие в данном проекте</span>
    </div>
  );
};