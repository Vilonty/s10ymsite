...
export const TopBlock =() => {
  return(
    ...
    <div  className={`${styles.rulesCommon} ${styles.rulesDark}`}>
      ...
      <span className={styles.title}>S10YM - survival 10 year minecraft (выживание 10 лет в майнкрафтe) </span>
      ...
      <span className={styles.title2}>При этом каждый желающий имеет возможность принять участие в данном проекте</span>
